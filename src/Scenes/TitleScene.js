...
export default class TitleScene extends Phaser.Scene {
  ...
  create() {
    this.gameButton = new Button(this, config.midx, config.midy - 70, 'blueButton1', 'blueButton2', 'Play', 'Game');
    this.optionsButton = new Button(this, config.midx, config.midy, 'blueButton1', 'blueButton2', 'Options', 'Options');
    this.creditsButton = new Button(this, config.midx, config.midy + 70, 'blueButton1', 'blueButton2', 'Credits', 'Credits');
